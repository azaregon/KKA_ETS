...
map_graph_file_path = "map_data.pkl"
...
hospitals_data = pd.read_json('hospital_seeding_data.json')
...
def get_fastest_route(lat,long) :
    # print(lat,long)

    korban_node = generate_node_korban(G,lat,long)
    route_result = findRoute(korban_node)
